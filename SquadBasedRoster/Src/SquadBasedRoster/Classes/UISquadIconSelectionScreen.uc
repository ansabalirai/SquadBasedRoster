...
class UISquadIconSelectionScreen extends UIScreen config(SquadBasedRoster);
...
simulated function InitScreen(XComPlayerController InitController, UIMovie InitMovie, optional name InitName)
{
	...
	ImageSelector.InitImageSelector(, 0, 70, m_kContainer.Width - 10, m_kContainer.height - 80, BelowScreen.SquadImagePaths, , SetSquadImage, BelowScreen.SquadImagePaths.Find(BelowScreen.GetCurrentSquad().SquadLogoPath));
}
...
function SetSquadImage(int iImageIndex)
{
	...
	Squad.SquadLogoPath = BelowScreen.SquadImagePaths[iImageIndex];
